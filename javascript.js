...
const ToDo = function(title) { 
    ...
    return {title, things_to_do, addItem, removeItem, remove_all_items_in_list, merge_all_projects};
  }; 
...
const todo_list_item = function(title, description, dueDate, priority, project){
    project = null;
...
const arrange_by_time = function(){
    ...
    for(let i=0; i<all_todo_items.length; i++) {
        //console.log(all_todo_items[i].dueDate.toLowerCase())
...
//console.log("Let's check if the errands todo list is filled with 5 items")
//console.log(errands.things_to_do)
//TESTING if an item is removed
/*
console.log("Now lets remove an item")
errands.removeItem("Walk dog")
console.log(errands.things_to_do) // there should be 4 items now
*/
...
grocery_shopping.addItem(apple)
grocery_shopping.addItem(banana)
//toBuy.addItem(grocery_shopping)


//const life_goals = Project("life goals");
...
remodeling_bathroom.addItem(tile)
remodeling_bathroom.addItem(wallpaper)
remodeling_bathroom.addItem(sketch)
...
workout_session.addItem(burpees)
workout_session.addItem(crunches)
workout_session.addItem(walk)
...
//TESTING
//What happens if I add or remove items after the todo lists have already been added to the myProjects?
//console.log(myProjects.projects_list[0].things_to_do.length) //5
//console.log(myProjects.projects_list[0].removeItem(myProjects.projects_list[0].things_to_do[1].title))
//console.log(myProjects.projects_list[0].things_to_do.length)//4

/*
console.log("Workout session project currently is: " + workout_session.things_to_do.length) //3
console.log(workout_session.things_to_do[1].title) 
console.log(workout_session.removeItem(workout_session.things_to_do[1].title))
console.log(workout_session.things_to_do.length) //2
/*

/*
console.log("Remove all item's from roject/TODO list")
console.log(workout_session.remove_all_items_in_list())
console.log(workout_session.things_to_do.length) //0


console.log("now to remove the project entirely")
*/
            ...
            if (project_selection!=null){
                for (let i=0; i<myProjects.projects_list.length;i++){
                    if(myProjects.projects_list[i].title == project_selection){
                        myProjects.projects_list[i].addItem(new_todo_item)
                    }
                }
            }
            //TODO add to todo lists based on when it should be done
            //TODO add a drop down to the projects we should add it to
            addModal.style.display = "none"
        }
        ...
        span_modal.onclick = function(){
            ...
            for(let j=0;j<myProjects.projects_list.length;j++){
                if (myProjects.projects_list[j].title == `${list_of_todo_items[i].project}`){
                    ...
                    console.log(myProjects.projects_list[j].removeItem(`${list_of_todo_items[i].title}`))
...
function render_notes(list_of_notes){
    ...
    for(i=0; i<list_of_notes.notes_list.length;i++){
